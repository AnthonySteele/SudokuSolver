...
There are more subtle ways to solve Sudoku boards, which use rules that behave move more like human strategies and only work sometimes, and these are the ways that people generally come up with first. But when the brute force method always gives the right answer, and is simple and fast, why bother?
